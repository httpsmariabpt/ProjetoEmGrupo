...
namespace projeto.Controllers
{
    public class AnimalController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("AnimalId,Nome,Tutor,Sexo,Especie,Raca,Idade,Peso,Observacao,Ecastrado")] Animal animal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(Guid id, [Bind("AnimalId,Nome,Tutor,Sexo,Especie,Raca,Idade,Peso,Observacao,Ecastrado")] Animal animal)
        {
